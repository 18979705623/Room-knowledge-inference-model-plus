...
#--en_nlayer 2 --num_layer 4 loss_weight 5 1 0 1
TORUN='--experiment_name check-train-1
--feedback_method sample2step --instruction_from reverie --batch_size=48
--en_nhead 6 --en_nlayer 3 --use_glove
--num_multihead 8 --num_layer 5
