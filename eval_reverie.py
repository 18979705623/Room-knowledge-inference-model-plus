...
usePano = True  # 选择一个视点作为下一个操作，它影响如何计算智能体的步骤。
...
class Evaluation(object):
    ''' 结果提交格式:  [{'instr_id': string, 'trajectory':[(viewpoint_id, heading_rads, elevation_rads),] } ] '''
...
if __name__=='__main__':
    ...
    env_result = json.load(open('/home/xiezilong/VLN_project/CKR/experiments/check-train-1/results/followersample2step_imagenet_mean_pooled_1heads_val_unseen_iter_19000.json'))
